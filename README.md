...
Replace the placeholder values with your actual respective account credentials. You can obtain these credentials by signing up on the [Auth.js](https://authjs.dev/), [MongoDB](https://www.mongodb.com/), [Cloudinary](https://cloudinary.com/) and [Stripe](https://stripe.com)
...
Deplyed app [link](https://pixel-ai-eosin.vercel.app/)
